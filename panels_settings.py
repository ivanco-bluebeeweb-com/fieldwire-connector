"""Settings panel for Fieldwire Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__fieldwire_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=fieldwire_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_fieldwire"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Fieldwire Settings & Accounts", level=2),
